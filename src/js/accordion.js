...
function accordion() {
  ...
  for (let index = 0; index < accordionContainer.length; index++) {
    ...
    addClass(
      button,
      "absolute block md:hidden right-0 transform -translate-y-1/2 focus:outline-none transition duration-200 rotate-"
    );
    button.style.top = "50%";
    ...
    button.addEventListener("click", onCLikcAccordion);
